...
vector<std::function<void(void)>> setupLua(bool client, const std::string& config)
{
  ...
  g_lua.writeFunction("MaxQPSIPRule", [](unsigned int qps, unsigned int burst, boost::optional<int> ipv4trunc, boost::optional<int> ipv6trunc) {
      return std::shared_ptr<DNSRule>(new MaxQPSIPRule(qps, burst, ipv4trunc.get_value_or(32), ipv6trunc.get_value_or(64)));
    });
  ...
  g_lua.registerMember<bool (DNSQuestion::*)>("skipcache", [](const DNSQuestion& dq) -> bool { return dq.skipcache; }, [](DNSQuestion& dq, bool newSkipCache) { (void) newSkipCache; });
